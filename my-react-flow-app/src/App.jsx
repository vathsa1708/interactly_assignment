...
const NodeOptions = ({ label, onUpdate, onDelete }) => {
  ...
  return (
    <div style={{ position: 'absolute', right: '10px', top: '10px', background: '#fff', padding: '20px', border: '2px solid #4CAF50', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.2)', zIndex: '999' }}>
...
export default function App() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative' }}>
      ...
      <button style={{ position: 'absolute', top: '10px', left: '10px', zIndex: 999, background: '#4CAF50', color: '#fff', border: 'none', borderRadius: '5px', padding: '10px', cursor: 'pointer' }} onClick={createNode}>Create Node</button>
    </div>
  );
}
